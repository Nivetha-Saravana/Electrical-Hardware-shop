          ...
          <Carousel.Item key={product._id}>
            <div style={{ position: 'relative', width: '100%', height: '450px' }}>
              ...
              <div style={{
                position: 'absolute',
                bottom: '10px',
                left: product.textAlign === 'left' ? '10px' : 'auto',
                right: product.textAlign === 'right' ? '10px' : 'auto',
                right: product.textAlign === 'right' ? '10px' : 'auto',
                ...
                padding: '5px 10px',
                borderRadius: '5px',
                marginLeft: index === 0 ? '30%' : 'auto', 
                  marginRight: index === 1 ? '100px' : 'auto',
                  marginRight: index === 2 ? '100px' : 'auto',
              }}>
                {product.text}
              </div>
            </div>
